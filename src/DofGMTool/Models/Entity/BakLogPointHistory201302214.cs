...
[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_log_point_history_20130221_4", DisableSyncStructure = true)]
public partial class BakLogPointHistory201302214
{
    ...
    public BakLogPointHistory201302214COMMAND Command { get; set; }
...
public enum BakLogPointHistory201302214COMMAND
{
    A = 1, U
}
