...
namespace DofGMTool.Models {
	...
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_log_issue_tran_history_20130103", DisableSyncStructure = true)]
	public partial class BakLogIssueTranHistory20130103 {
