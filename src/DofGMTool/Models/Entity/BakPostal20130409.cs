...
[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_postal_20130409", DisableSyncStructure = true)]
public partial class BakPostal20130409
{
    ...
    [JsonProperty, Column(Name = "postal_id")]
    public uint PostalId { get; set; } = 0;
