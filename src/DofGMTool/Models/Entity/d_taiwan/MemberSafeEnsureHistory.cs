...
namespace DofGMTool.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "member_safe_ensure_history", DisableSyncStructure = true)]
	public partial class MemberSafeEnsureHistory {
		...
		[JsonProperty, Column(Name = "mod_time", DbType = "datetime", InsertValueSql = "0000-00-00 00:00:00")]
