...
namespace DofGMTool.Models {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "member_info", DisableSyncStructure = true)]
	public partial class MemberInfo {
		...
		public MemberInfoEMAILYN EmailYn { get; set; }
		...
		[JsonProperty, Column(Name = "m_type")]
		public sbyte MType { get; set; } = 0;
