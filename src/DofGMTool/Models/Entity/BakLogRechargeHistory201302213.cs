...
namespace DofGMTool.Models {
	...
	/// recharge history
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_log_recharge_history_20130221_3", DisableSyncStructure = true)]
	public partial class BakLogRechargeHistory201302213 {
