...
namespace DofGMTool.Models {
	...
	/// purchase history
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_log_purchase_history_20130221_4", DisableSyncStructure = true)]
	public partial class BakLogPurchaseHistory201302214 {
