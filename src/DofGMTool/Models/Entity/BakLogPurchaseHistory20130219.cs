...
namespace DofGMTool.Models {
	...
	/// purchase history
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_log_purchase_history_20130219", DisableSyncStructure = true)]
	public partial class BakLogPurchaseHistory20130219 {
