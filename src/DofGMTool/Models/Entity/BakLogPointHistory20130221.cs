...
[JsonObject(MemberSerialization.OptIn), Table(Name = "bak_log_point_history_20130221", DisableSyncStructure = true)]
public partial class BakLogPointHistory20130221
{
    ...
    public BakLogPointHistory20130221COMMAND Command { get; set; }
...
public enum BakLogPointHistory20130221COMMAND
{
    A = 1, U
}
