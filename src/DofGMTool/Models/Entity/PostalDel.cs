...
[JsonObject(MemberSerialization.OptIn), Table(Name = "postal_del", DisableSyncStructure = true)]
public partial class PostalDel
{

    [JsonProperty, Column(Name = "postal_id", IsPrimary = true)]
